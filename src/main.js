...
const CHANGELOG = [
  ['3.3.0', 'Neues Festival NATURE ONE 2026 (Crew via Spektralwerk): Crew-Infos aus Personal-Briefing (I-Motion) und Running Order (Spektralwerk) als Anleitungen – Anreise/Parken, Crew-Basics & Funk, Cashless, Notfall, Checkliste, Ablauf/Öffnungszeiten, Akkreditierung, Catering, Check-in/-out, Kleidung/Verhalten, Funken, Kontakt. Eigene Einsatzzeiten im Dienstplan; offizielle Kontakte in der Referenz. NATURE ONE nutzt ein eigenes (I-Motion) Cashless-System – die GET-Cashless-Anleitungen laufen dort bewusst nicht mit.'],
